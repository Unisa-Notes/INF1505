	...
	\chapter{Operational Systems}
		...
		\section{Traditional Transaction Processing Applications}
			...
			\subsection{Order Processing Systems}
				\begin{tblr}{colspec={>{\raggedright}X>{\raggedright}X[1.5]>{\raggedright}X[1.5]>{\raggedright}X}, row{even}={table even}, row{1}={font=\bfseries}}
					\toprule
			...
			\subsection{Purchasing Systems}
				\begin{tblr}{colspec={>{\raggedright}X>{\raggedright}X>{\raggedright}X>{\raggedright}X}, row{even}={table even}, row{1}={font=\bfseries}}
					\toprule
					System & Input & Processing & Output\\
					\midrule
