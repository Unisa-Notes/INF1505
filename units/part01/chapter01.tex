		...
		\section{What is an Information System?}
			...
			\subsection{Manual and Computerised Information Systems}
				\begin{definition}{Computer-Based Information System (CBIS)}
					A single set of \concept{hardware}, \concept{software}, \concept{databases}, \concept{telecommunications}, \concept{people} and \concept{procedures} that is configured to collect, manipulate, store and process data inro information. 
				\end{definition}
		...
		\section{Business Information Systems}
			...
			\subsection{Different System Types}
				...
				\subsubsection{Knowledge Management Systems}
					...
					\end{definition}
					The major elements of \concept{Artifical Intelligence} are:
					\begin{indentparagraph}
						\begin{description}
			...
			\section{Global Challenges in Information Systems}
				...
				\begin{exercise}{Self-Assessment}
					\begin{enumerate}
						...
						\item An \concept{exective information system} supports long-term strategic decision making.
